...
public class BeaconManagerJellyBean extends BeaconManager{
     ...
     */
    protected BeaconManagerJellyBean(Context context) throws BluetoothNotSuportedException, BluetoothLENotSuportedException, BluetoothNotActivatedException {
        super(context);
    ...
    private class BeaconScanStopRunnable implements Runnable {
    ...
    private class BeaconScanStartRunnable implements Runnable {
